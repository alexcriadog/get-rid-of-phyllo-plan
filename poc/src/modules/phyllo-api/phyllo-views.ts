// View builders for the Phyllo-compatible account/user/work-platform shapes
...
export function accountView(
  ...
  return {
    id: phylloAccountId(acc.id.toString()),
    created_at: naiveUtc(acc.connectedAt ?? acc.createdAt),
    updated_at: naiveUtc(acc.updatedAt),
    user: {
      id: phylloUserIdOrFallback(acc.endUserId, acc.id.toString()),
      name: acc.endUserId,
    },
    work_platform: wp
