...
/**
 * Our ContentType → Phyllo (format, type). format ∈
 * VIDEO/IMAGE/AUDIO/TEXT/OTHER; type ∈ the Phyllo content-type vocabulary.
...
/**
 * ISO-8601 duration (YouTube "PT4M13S") → integer seconds (Phyllo `int`).
...
/** Normalize a gender label to Phyllo's MALE/FEMALE/OTHER. */
