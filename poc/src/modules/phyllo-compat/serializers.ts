// Serialization helpers that make our output byte-compatible with Phyllo.
//
//  - Timestamps: naive ISO with microseconds, NO timezone suffix
//    (Phyllo: "2026-06-05T11:12:04.637922", UTC implied). JS Date is
//    millisecond-precision, so we pad the microsecond digits with zeros.
//  - Percentages: 0..100 scale with 2 decimals (Phyllo: 62.95).
...
/** Round a number to 2 decimals (Phyllo percentage precision). */
