// List + error envelope helpers matching Phyllo's exact response shapes
...
import type { PhylloListEnvelope } from "./phyllo-types";
...
export interface PhylloErrorBody {
  error: {
    type: string;
    code: string;
    error_code: string;
