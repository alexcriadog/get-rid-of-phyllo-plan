...
/**
 * Everything a mapper needs to build the Phyllo envelope around a piece of
 ...
 */
export interface PhylloContext {
  ...
  /** Row created_at (Phyllo envelope created_at). */
  createdAt: Date;
  /** Row updated_at (Phyllo envelope updated_at). */
  updatedAt: Date;
}
