import { accountView, userView } from "../views";
import { parseOffsetLimit, parseDate } from "../http";
import { listEnvelope, errorEnvelope } from "@modules/data-schema";
...
describe("accountView", () => {
  test("matches the InsightIQ account top-level keys", () => {
    const v = accountView(
      acc,
      [
        {
...
describe("pagination + envelopes", () => {
  ...
  test("errorEnvelope shape mirrors InsightIQ", () => {
