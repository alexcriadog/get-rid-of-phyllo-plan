...
export const PANEL_DEFS: Record<PanelId, PanelDef> = {
  ...
  cadence: { title: 'Cadence', component: lazy(() => import('./CadencePanel')) },
  'rate-limits': { title: 'Rate Limits & Locks', component: lazy(() => import('./RateLimitsPanel')) },
  'kpi-stats': { title: 'KPI Stats', component: lazy(() => import('./KpiStatsPanel')) },
  'tenant-directory': { title: 'Tenant Directory', component: lazy(() => import('./TenantDirectoryPanel')) },
  'tenant-inspector': { title: 'Tenant Inspector', component: lazy(() => import('./TenantInspectorPanel')) },
  'account-directory': { title: 'Account Directory', component: lazy(() => import('./AccountDirectoryPanel')) },
  'account-inspector': { title: 'Account Inspector', component: lazy(() => import('./AccountInspectorPanel')) },
  'capability-matrix': { title: 'Capability Matrix', component: lazy(() => import('./CapabilityMatrixPanel')) },
  usage: { title: 'Usage & Storage', component: lazy(() => import('./UsagePanel')) },
  'runtime-settings': { title: 'Runtime Settings', component: lazy(() => import('./RuntimeSettingsPanel')) },
