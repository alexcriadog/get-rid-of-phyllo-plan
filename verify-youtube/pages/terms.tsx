      ...
      <div className="v-shell">
        ...
        <div className="v-legal-prose">
          ...
          <p>
            ...
            audience, engagement, and revenue metrics of YouTube channels whose
            owners have connected them through Google&rsquo;s OAuth flow. Access
            is read-only and limited to the connected channel.
          </p>
